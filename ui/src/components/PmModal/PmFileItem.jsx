  ...
  return (
    <div className="border border-ctp-surface0 rounded-lg overflow-hidden">
      <button
        ...
        className="flex items-center justify-between px-3 py-2 cursor-pointer hover:bg-ctp-surface0/40 transition-colors duration-150 w-full bg-transparent border-0 text-left"
      >
