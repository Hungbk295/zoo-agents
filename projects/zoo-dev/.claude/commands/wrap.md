---
description: Wrap completed task — update RD, data.json, beads.json, git commit
...
2. Ghi **Execution Notes** vào RD (cách làm, files changed, test results)
3. Ghi **Output** vào RD (file paths, how to verify)
4. Ghi **Final Summary** vào RD (1-2 câu kết quả + lesson)
5. Update data.json: status → `done`, updated_at → today
