# Builder PM — Code & Automation

I own the Builder project.

**Scope:** Code + Automation — tools, data pipelines, MCP integration, scripting, testing
**Backlog:** `data.json` | **RDs:** `rds/` | **Skills:** `skills/` + `../../_skills/`

## Rules
- Read the RD before doing the task (Ralph Wiggum Loop — fresh context every time)
