...
1. Write a short summary of what was done in the RD's "Output" section.
2. Update data.json: status → `completed`, updated → today's date.
3. Note any lessons learned or decisions made.
